(function ($) {
    ...
    $(function () {
        ...
        /*-------------------------------------
         Popup
         -------------------------------------*/
        var uPopUp = $(".popup-youtube");
        if (uPopUp.length) {
            uPopUp.magnificPopup({
                disableOn: 700,
                type: 'iframe',
                mainClass: 'mfp-fade',
                removalDelay: 160,
        ...
        var ezs = $('.elv-zoom-single');
        if (ezs.length) {
            ezs.magnificPopup({type: 'image'});
        }
        var zoomGallery = $('.zoom-gallery');
        if (zoomGallery.length) {
            zoomGallery.each(function () { // the containers for all your galleries
                $(this).magnificPopup({
    ...
    $('nav#dropdown').meanmenu({
        siteLogo: "<a href='index.html' class='logo-mobile-menu'><img src='img/logo.png' style='width: 150px;' /></a>"
    });
    ...
    /*-------------------------------------
     Jquery Sticky Menu at window Load
     -------------------------------------*/
    ...
    /*-------------------------------------
     Accordion
     -------------------------------------*/
    var accordion = $('#accordion, #accordion2, #accordion3, #accordion4');
